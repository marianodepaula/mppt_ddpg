...
if __name__ == '__main__':
	...
	#Create the environment for A2C:
	# multiprocess environment
	n_cpu = 4
	env = SubprocVecEnv([lambda: gym.make('mppt-v0') for i in range(n_cpu)])
	...
	model = A2C(MlpPolicy, env, verbose=1) #ojo que usa el MlpPolicy del common policies (uncomment line 4 and comment line 5)
